...
type VolumeRestoreInterface interface {
	Create(ctx context.Context, volumeRestore *v1beta1.VolumeRestore, opts v1.CreateOptions) (*v1beta1.VolumeRestore, error)
	Update(ctx context.Context, volumeRestore *v1beta1.VolumeRestore, opts v1.UpdateOptions) (*v1beta1.VolumeRestore, error)
	UpdateStatus(ctx context.Context, volumeRestore *v1beta1.VolumeRestore, opts v1.UpdateOptions) (*v1beta1.VolumeRestore, error)
	Delete(ctx context.Context, name string, opts v1.DeleteOptions) error
	DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error
	Get(ctx context.Context, name string, opts v1.GetOptions) (*v1beta1.VolumeRestore, error)
	List(ctx context.Context, opts v1.ListOptions) (*v1beta1.VolumeRestoreList, error)
	Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error)
	Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta1.VolumeRestore, err error)
...
func newVolumeRestores(c *QuchengV1beta1Client, namespace string) *volumeRestores {
...
func (c *volumeRestores) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1beta1.VolumeRestore, err error) {
	result = &v1beta1.VolumeRestore{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *volumeRestores) List(ctx context.Context, opts v1.ListOptions) (result *v1beta1.VolumeRestoreList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1beta1.VolumeRestoreList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("volumerestores").
...
func (c *volumeRestores) Create(ctx context.Context, volumeRestore *v1beta1.VolumeRestore, opts v1.CreateOptions) (result *v1beta1.VolumeRestore, err error) {
	result = &v1beta1.VolumeRestore{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("volumerestores").
...
func (c *volumeRestores) Update(ctx context.Context, volumeRestore *v1beta1.VolumeRestore, opts v1.UpdateOptions) (result *v1beta1.VolumeRestore, err error) {
	result = &v1beta1.VolumeRestore{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("volumerestores").
...
func (c *volumeRestores) UpdateStatus(ctx context.Context, volumeRestore *v1beta1.VolumeRestore, opts v1.UpdateOptions) (result *v1beta1.VolumeRestore, err error) {
	result = &v1beta1.VolumeRestore{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("volumerestores").
...
func (c *volumeRestores) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta1.VolumeRestore, err error) {
	result = &v1beta1.VolumeRestore{}
